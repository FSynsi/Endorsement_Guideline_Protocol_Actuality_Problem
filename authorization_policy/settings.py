"""
Django settings for authorization_policy project.
...
from authorization_policy.emailsetting import SET_EMAIL_USE_TLS, SET_EMAIL_HOST, SET_EMAIL_HOST_USER, \
...
SECRET_KEY = 'qeub&t93x!9bk3x4w9xc6e3-_0%we@zfbmpy*a^#0=51q41zi+'
...
ROOT_URLCONF = 'authorization_policy.urls'
...
WSGI_APPLICATION = 'authorization_policy.wsgi.application'
